...
analysis() {
    ...
    poetry run python result_analysis/__main__.py --repo_sample /home/user/dataset/repo-sample.yaml --results_dir /home/user/evaluation-workdir/results/"$1" --metrics_file /home/user/metrics-"$1".tex
