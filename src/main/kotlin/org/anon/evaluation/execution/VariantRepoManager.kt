...
class VariantRepoManager(
    ...
    private val shellSourceV0: ShellExecutor =
        ShellExecutor(Logger::debug, {}, sourceVariantV0)
    private val shellSourceV1: ShellExecutor =
        ShellExecutor(Logger::debug, {}, sourceVariantV1)
    private val shellTargetV0: ShellExecutor =
        ShellExecutor(Logger::debug, {}, targetVariantV0)
    private val shellTargetV1: ShellExecutor =
        ShellExecutor(Logger::debug, {}, targetVariantV1)
    ...
    fun resetTargetVariant() {
        try {
            ...
            failure = failure || shellTargetV0.execute(
                GitRestoreCommand(
                    "."
                ).staged()).isFailure
            failure = failure || shellTargetV0.execute(
            ...
            if (failure) {
                ...
                val tempExecutor = ShellExecutor(
                    Logger::warn,
                    Logger::warn,
                    targetVariantV0.parent
                )
