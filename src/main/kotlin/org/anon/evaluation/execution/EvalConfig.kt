...
import org.anon.evaluation.CherryType
import java.io.File
...
class EvalConfig(propertiesFile: File) {
    ...
    fun EXPERIMENT_CHERRY_TYPE(): org.anon.evaluation.CherryType {
        return config!!.getEnum(EXPERIMENT_CHERRY_TYPE, org.anon.evaluation.CherryType::class.java)
    }
